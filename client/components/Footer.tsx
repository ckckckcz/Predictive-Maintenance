    ...
    return (
        <footer className="relative w-full bg-white flex flex-col items-center font-sans overflow-hidden">
            ...
            <div className="relative w-[90%] max-w-7xl flex flex-col">
                ...
                {/* Vertical Grid Lines */}
                <div className="absolute top-[-100vh] bottom-[-100vh] left-0 w-[1px] bg-[#2563eb] opacity-20 pointer-events-none" />
                <div className="absolute top-[-100vh] bottom-[-100vh] right-0 w-[1px] bg-[#2563eb] opacity-20 pointer-events-none" />

                {/* Main Footer */}
                <div className="relative w-full lg:py-16 py-10 px-4 md:px-8">

                    {/* Horizontal Grid Lines */}
                    <div className="absolute top-0 left-[-100vw] right-[-100vw] h-[1px] bg-[#2563eb] opacity-20 pointer-events-none" />
                    <div className="absolute bottom-0 left-[-100vw] right-[-100vw] h-[1px] bg-[#2563eb] opacity-20 pointer-events-none" />

                    {/* Corner Marks */}
                    <div className="absolute top-[-1px] left-[-1px] w-3 h-3 border-t-[1.5px] border-l-[1.5px] border-[#2563eb]" />
                    <div className="absolute top-[-1px] right-[-1px] w-3 h-3 border-t-[1.5px] border-r-[1.5px] border-[#2563eb]" />
                    <div className="absolute bottom-[-1px] left-[-1px] w-3 h-3 border-b-[1.5px] border-l-[1.5px] border-[#2563eb]" />
                    <div className="absolute bottom-[-1px] right-[-1px] w-3 h-3 border-b-[1.5px] border-r-[1.5px] border-[#2563eb]" />
                    ...
                    <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
                        ...
                        <div className="flex flex-col gap-5">
                            ...
                            <div className="flex flex-col gap-3.5 text-[14px] text-gray-500">
                                <Link href="#" className="hover:text-[#2563eb] transition-colors w-fit">
                                    Dokumentasi
                                </Link>
